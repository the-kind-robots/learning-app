...
(defn- asset-paths
  "Every file under `dir` as a request path, sorted. An inventory, not a
   choice: which of these the app shell precaches is the server's rule, applied
   to this list and to a source checkout's walk alike.
