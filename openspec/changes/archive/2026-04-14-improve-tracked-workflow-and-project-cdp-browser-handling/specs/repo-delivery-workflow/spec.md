## Purpose
Define reliable tracked delivery behavior for repo-local Codex workflows so likely repository changes are tracked and GitHub Project automation tolerates absent optional fields.
