...
The words screen SHALL show neither a back button nor a visible heading; its search field is the first thing under the shell bar. The screen SHALL keep the level-one heading «Мои слова» for assistive technology, visually hidden.
